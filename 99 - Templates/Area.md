...
createButton("📥 Archive Area", "quickadd:choice:archive-active-note", "background-color: var(--interactive-accent); color: var(--text-on-accent); border: none; font-weight: 600;");
```
